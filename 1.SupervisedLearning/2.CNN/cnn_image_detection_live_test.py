...
live_test = image.load_img('dataset/single_prediction/cat_or_dog_2.jpg',target_size=(64,64,3))
live_test = image.img_to_array(live_test)
live_test = np.expand_dims(live_test, axis=0)
output = classifier.predict(live_test)
training_set.class_indices
if output[0][0]==0:
    print('yeah!!!!!!!!!!!, you inputted image ===> cat')
else:
    print('yeah!!!!!!!!!!!, you inputted image ===> dog')